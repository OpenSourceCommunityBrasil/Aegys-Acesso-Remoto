...
Type
 ...
 TInternalCommand  = (ticNone,               ticLogin,
                      ticConnectionList,     ticConnectionEdit,
                      ticDataStatus,         ticFindID,
                      ticIDExistsReqPass,    ticIDNotFound,
                      ticPing,               ticPong,
                      ticCheckPass,          ticAccessGranted,
                      ticAccessDenied,       ticGetMonitorCount,
                      ...
                      ticSetPortRec,         ticChangeImageQuality,
